...
public class PIIArrayOfActorPncm extends Vector< PIIActorPncm> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj, PIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                PIIActorPncm j1= (PIIActorPncm)__envelope.get(j,PIIActorPncm.class,false);
                add(j1);
            }
        }
    }
