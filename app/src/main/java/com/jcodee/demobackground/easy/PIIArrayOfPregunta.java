...
public class PIIArrayOfPregunta extends Vector< PIIPregunta> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj, PIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                PIIPregunta j1= (PIIPregunta)__envelope.get(j,PIIPregunta.class,false);
                add(j1);
            }
        }
    }
