...
public class PIIRolFicha extends AttributeContainer implements KvmSerializable
{
        ...
        if (info.name.equals("RolId"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.RolId = new Long(j.toString());
                    }
                }
                else if (obj instanceof Long){
                    this.RolId = (Long)obj;
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==3)
        {
            return this.RolId!=null?this.RolId:SoapPrimitive.NullSkip;
        }
        return null;
    }
