...
public class PIIArrayOfRolFicha extends Vector< PIIRolFicha> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj, PIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                PIIRolFicha j1= (PIIRolFicha)__envelope.get(j,PIIRolFicha.class,false);
                add(j1);
            }
        }
    }
