...
public class PIIArrayOfMenu extends Vector< PIIMenu> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj, PIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                PIIMenu j1= (PIIMenu)__envelope.get(j,PIIMenu.class,false);
                add(j1);
            }
        }
    }
