...
public class PIIArrayOfComiteActor extends Vector< PIIComiteActor> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj, PIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                PIIComiteActor j1= (PIIComiteActor)__envelope.get(j,PIIComiteActor.class,false);
                add(j1);
            }
        }
    }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "ComiteActor";
        info.type = PIIComiteActor.class;
