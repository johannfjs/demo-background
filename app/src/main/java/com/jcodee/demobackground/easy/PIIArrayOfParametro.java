...
public class PIIArrayOfParametro extends Vector< PIIParametro> implements KvmSerializable
{
    ...
    public void loadFromSoap(Object inObj, PIIExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                PIIParametro j1= (PIIParametro)__envelope.get(j,PIIParametro.class,false);
                add(j1);
            }
        }
    }
